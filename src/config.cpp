...
static std::string scancode_to_token(SDL_Scancode sc) {
    ...
    switch (sc) {
    case S::SDL_SCANCODE_LEFT:
        return "LEFT";
    case S::SDL_SCANCODE_RIGHT:
        return "RIGHT";
    case S::SDL_SCANCODE_UP:
        return "UP";
    case S::SDL_SCANCODE_DOWN:
        return "DOWN";
    case S::SDL_SCANCODE_SPACE:
        return "SPACE";
    case S::SDL_SCANCODE_RETURN:
        return "RETURN";
    case S::SDL_SCANCODE_ESCAPE:
        return "ESCAPE";
    case S::SDL_SCANCODE_BACKSPACE:
        return "BACKSPACE";
    case S::SDL_SCANCODE_COMMA:
        return ",";
    case S::SDL_SCANCODE_PERIOD:
        return ".";
    case S::SDL_SCANCODE_MINUS:
        return "-";
    case S::SDL_SCANCODE_EQUALS:
        return "=";
    case S::SDL_SCANCODE_LSHIFT:
        return "LSHIFT";
    case S::SDL_SCANCODE_RSHIFT:
        return "RSHIFT";
    case S::SDL_SCANCODE_LCTRL:
        return "LCTRL";
    case S::SDL_SCANCODE_RCTRL:
        return "RCTRL";
    case S::SDL_SCANCODE_LALT:
        return "LALT";
    case S::SDL_SCANCODE_RALT:
        return "RALT";
    default:
        break;
    }
...
bool save_input_bindings_to_ini(const std::string& path, const struct InputBindings& b) {
    ...
    if (!f.is_open())
        return false;
    auto W = [&](const char* key, SDL_Scancode sc) {
        f << key << "=" << scancode_to_token(sc) << "\n";
    };
    W("left", b.left);
    W("right", b.right);
    W("up", b.up);
