...
void lua_register_guns(sol::state& s, LuaManager& m) {
    s.set_function("register_gun", [&m](sol::table t) {
        ...
        GunHooks gh{};
        if (auto o = t.get<sol::object>("on_eject"); o.is<sol::function>())
            gh.on_eject = o.as<sol::protected_function>();
        sol::object orls = t.get<sol::object>("on_reload_start");
        if (orls.is<sol::function>())
            gh.on_reload_start = orls.as<sol::protected_function>();
        sol::object orlf = t.get<sol::object>("on_reload_finish");
        if (orlf.is<sol::function>())
            gh.on_reload_finish = orlf.as<sol::protected_function>();
        d.ar_pos_variance = t.get_or("ar_pos_variance", 0.0f);
        if (auto o = t.get<sol::object>("on_jam"); o.is<sol::function>())
            gh.on_jam = o.as<sol::protected_function>();
        if (auto o = t.get<sol::object>("on_active_reload"); o.is<sol::function>())
            gh.on_active_reload = o.as<sol::protected_function>();
        if (auto o = t.get<sol::object>("on_failed_active_reload"); o.is<sol::function>())
            gh.on_failed_active_reload = o.as<sol::protected_function>();
        if (auto o = t.get<sol::object>("on_tried_to_active_reload_after_failing");
            o.is<sol::function>())
            gh.on_tried_after_failed_ar = o.as<sol::protected_function>();
        if (auto o = t.get<sol::object>("on_pickup"); o.is<sol::function>())
            gh.on_pickup = o.as<sol::protected_function>();
        if (auto o = t.get<sol::object>("on_drop"); o.is<sol::function>())
            gh.on_drop = o.as<sol::protected_function>();
        if (auto o = t.get<sol::object>("on_step"); o.is<sol::function>())
            gh.on_step = o.as<sol::protected_function>();
