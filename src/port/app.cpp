...
bool app_init(App& app) {
    ...
    gameplay_init(app.gameplay, app.assets);
...
void app_run(App& app) {
    while (app.running) {
        ...
        while (SDL_PollEvent(&event)) {
            gameplay_handle_event(app.gameplay, app.assets, event, app.running);
        }
        ...
        gameplay_update(app.gameplay, app.assets, dt);
        gameplay_render(app.gameplay, app.assets, app.renderer, SDL_GetTicks64());
