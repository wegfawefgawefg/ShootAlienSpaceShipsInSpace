...
enum class PickupEffectType {
    ...
    UpgradeRandomSpread,
    UpgradeRandomPierce,
    UpgradeRandomRicochet,
    UpgradeRandomTracking,
    UpgradeRandomBlast,
    UpgradeRandomVelocity,
    UpgradeRandomBurstMode,
    UpgradeRandomBeamLens,
    UpgradeRandomBurstCount,
    UpgradeRandomBurstCadence,
    UpgradeRandomBeamWidth,
    UpgradeRandomBeamLength,
    UpgradeRandomBeamDamage,
    UpgradeRandomOrbitalCount,
    ExtraLife,
    ExtraWeaponSlot,
    ExtraStashSlot,
    PickupMagnet,
